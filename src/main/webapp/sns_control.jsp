<%@ page language="java" contentType="text/html;charset=UTF-8"
	pageEncoding="UTF-8" import="sns.*,sns.member.*,java.util.*"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>

<!-- 메시지 처리 빈즈 -->
<jsp:useBean id="msg" class="sns.member.Message" />
<jsp:useBean id="msgdao" class="sns.member.MessageDAO" />
<jsp:useBean id="reply" class="sns.member.Reply" />
